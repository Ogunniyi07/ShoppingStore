    ...
    <div>
        ...
        <Navbar/>
            <div className='m-4'>
                ...
                <NavLink to="/CategoryPage"> <button className='btn bg-white text-[#8a4af3] border-2 border-[#8a4af3] hover:bg-white'>Continue Shopping</button></NavLink>
                       ...
                       <div className='flex w-[100%] h-auto items-center mobile:flex-col'>
                            ...
                            <div className='description flex flex-col ml-5 h-auto justify-between'>
                                ...
                                <p className='flex items-center justify-start'>
                                    ...
                                    <div className='rounded-full border-2 p-[10px] cursor-pointer ml-1 w-[20px] h-[20px] bg-blue-400'>

                                    </div>
                                </p>
                                <p>
                                    <b className='mr-2'>Sizes:</b>lg
                                </p>
                            </div>
                            </div>
